	...
	<div class="w3-section">
	  	<input class="w3-input w3-border w3-margin-bottom" type="text" placeholder="아이디" name="id" required>
	   	...
	   	<button class="w3-button w3-block w3-green w3-section w3-padding" type="submit">로그인</button>
	        <span class="w3-right w3-padding w3-hide-small"><a href="/semi/poke/main.jsp?page=/main/findPwd.jsp">비밀번호찾기</a></span>
	        <span class="w3-right w3-padding w3-hide-small"><a href="/semi/poke/main.jsp?page=/main/findId.jsp">아이디찾기</a></span>
	</div>
</form>
</body>
</html>