	...
	<div class="w3-section">
		<input type="hidden" value = <%= session.getAttribute("id") %> name="id">
	  	<input class="w3-input w3-border w3-margin-bottom" type="text" placeholder="이메일" name="email" required>
	   	...
	   	<span class="w3-right w3-padding w3-hide-small"><a href="/semi/poke/main.jsp?page=/main/mypage/withDrawal.jsp">회원탈퇴</a></span>
	   	<span class="w3-right w3-padding w3-hide-small"><a href="/semi/poke/main.jsp?page=/main/mypage/pwdChange.jsp">비밀번호변경</a></span>
	</div>
</form>
</body>
</html>