...
@WebServlet("/lol/lboard.do")
public class LboardController extends HttpServlet{
	@Override
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		LboardDao dao=LboardDao.getInstance();
		ArrayList<LboardVo> list=dao.list(startRow, endRow, sort, search, keyword);
